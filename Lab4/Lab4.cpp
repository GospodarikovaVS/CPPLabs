...
BEGIN_MESSAGE_MAP(CLab4App, CWinAppEx)
...
BOOL CLab4App::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(IDR_Lab4TYPE,
...
// CLab4App customization load/save methods

void CLab4App::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CLab4App::LoadCustomState()
{
}

void CLab4App::SaveCustomState()
{
}
